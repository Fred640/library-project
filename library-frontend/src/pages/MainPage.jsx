...
const MainPage = () => {
  ...
  const Elements = [
    ...
    {content:<><Link to={'/users/'} style={{textDecoration:"none"}}><Btn>Авторы</Btn></Link>/<Link to={'/diaries'} style={{textDecoration:"none"}}><Btn>Дневники</Btn></Link></>, divClasses:"col-lg-4 col-md-6 col-12"},
